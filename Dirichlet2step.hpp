...
class Dirichlet2step : public DirichletSolverModel
{
    Q_OBJECT

public:
    explicit Dirichlet2step(QObject *parent = nullptr);
    ...
    Dirichlet2step::FinerGridResult computeFinerGridComparison() const;
